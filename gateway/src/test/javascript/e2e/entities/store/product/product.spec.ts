...
describe('Product e2e test', () => {
  ...
  it('should create and save Products', async () => {
    ...
    await promise.all([
      ...
      productUpdatePage.setObservationInput('observation'),
    ...
    expect(await productUpdatePage.getObservationInput()).to.eq('observation', 'Expected Observation value to be equals to observation');
